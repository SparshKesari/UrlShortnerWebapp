...
export const LoginButton = ({ handleLoginModal }) => {
  ...
  const ButtonProps =
    'p-1 tracking-wider border-b-2 border-l-2 border-yellow-500 px-2 rounded mx-2 shadow-lg z-70 font-bold text-gray-900 hover:transform hover:scale-95 focus:outline-none'
  return (
    <>
